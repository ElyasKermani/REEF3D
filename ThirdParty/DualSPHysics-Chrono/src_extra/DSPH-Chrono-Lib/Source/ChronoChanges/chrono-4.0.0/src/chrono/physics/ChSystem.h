...
class ChApi ChSystem : public ChAssembly, public ChIntegrableIIorder {
  ...
  public:
    /// Enum for SMC contact type.    //<vs_dsphchanges> : Move the enums from ChSystemSMC to ChSystem to extend the class
    ...
    virtual void SetContactForceModel(ContactForceModel model){};//<vs_dsphchanges> : Added virtual function.  It will be override by ChSystemSMC
    /// Set the adhesion force model.
    virtual void SetAdhesionForceModel(AdhesionForceModel model){}//<vs_dsphchanges> : Added virtual function
