...
ChMaterialSurfaceNSC::ChMaterialSurfaceNSC()
    : static_friction(0.6f),
      ...
      complianceRoll(0),
      complianceSpin(0),
      impose_friction(false){} ///< Impose the static_friction and sliding_friction over other materials. //<vs_dsphchanges>: Initialise to false
...
ChMaterialSurfaceNSC::ChMaterialSurfaceNSC(const ChMaterialSurfaceNSC& other) {
    ...
    impose_friction=other.impose_friction;  ///< Impose the static_friction and sliding_friction over other materials. //<vs_dsphchanges>: Copy value from other
}
...
ChMaterialCompositeNSC::ChMaterialCompositeNSC(ChMaterialCompositionStrategy<float>* strategy,
    ...
    //<vs_dsphchanges_ini>: Imposed kfric
    if(mat1->impose_friction && !mat2->impose_friction){
      static_friction =mat1->static_friction;
      sliding_friction=mat1->sliding_friction;
    }
    else if(!mat1->impose_friction && mat2->impose_friction){
      static_friction =mat2->static_friction;
      sliding_friction=mat2->sliding_friction;
    }
    else{
