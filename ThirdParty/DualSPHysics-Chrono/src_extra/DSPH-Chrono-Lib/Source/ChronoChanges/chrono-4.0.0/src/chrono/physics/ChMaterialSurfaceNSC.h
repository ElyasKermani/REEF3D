...
class ChApi ChMaterialSurfaceNSC : public ChMaterialSurface {
  ...
  public:
    ...
    bool impose_friction;     ///< Impose the static_friction and sliding_friction over other materials. //<vs_dsphchanges>: Add boolean variable 
    ...
    //<vs_dsphchanges_ini>
    /// Set/Get if this material will impose its friction coefficients
    bool GetImposeFric() const { return impose_friction; }
    void SetImposeFric(bool val) { impose_friction = val; }
    //<vs_dsphchanges_end>
