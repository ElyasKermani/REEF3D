...
class ChApi ChSystemSMC : public ChSystem {
  ...
  public:
    ...
    virtual void SetContactForceModel(ContactForceModel model)override { m_contact_model = model; } //<vs_dsphchanges> : Added virtual function 
    /// Get the current normal contact force model.
    ContactForceModel GetContactForceModel(){ return m_contact_model; } 

    /// Set the adhesion force model.
    virtual void SetAdhesionForceModel(AdhesionForceModel model) override{ m_adhesion_model = model; }//<vs_dsphchanges> : Added virtual function
