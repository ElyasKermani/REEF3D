...
ChLinkPulley::ChLinkPulley()
    : a1(0),
      ...
      belt_low2(VNULL) {
    // initializes type
    //local_shaft1.SetIdentity(); <vs_dsphchanges> : commented to avoid segmentation fault on Linux
    //local_shaft2.SetIdentity(); <vs_dsphchanges> : commented to avoid segmentation fault on Linux
