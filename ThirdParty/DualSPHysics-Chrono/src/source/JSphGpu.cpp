...
void JSphGpu::ComputeSymplecticPre(double dt){
  ...
  //-Avoid penetration in a box domain.                    //<vs_fttmdbc_ini>
  if(MdbcLimit)cusph::ComputeStepMdbcLimit(Np,Npb,MdbcLimitMin,MdbcLimitMax
    ,Codeg,PosxyPreg,PoszPreg,movxyg,movzg,Velrhopg);      //<vs_fttmdbc_end>
...
void JSphGpu::ComputeSymplecticCorr(double dt){
  ...
  //-Avoid penetration in some direction (in development). //<vs_fttmdbc_ini>
  if(MdbcLimit)cusph::ComputeStepMdbcLimit(Np,Npb,MdbcLimitMin,MdbcLimitMax
    ,Codeg,PosxyPreg,PoszPreg,movxyg,movzg,Velrhopg);      //<vs_fttmdbc_end>
  ...
  ,const double2 *posxyg,const double *poszg,const unsigned *idpg,const float3 *boundnormalg)
{
  //-Allocates memory.
  unsigned n=npb;
  if(UseNormalsFt)n=np;  //<vs_fttmdbc>
