...
protected:
  ...
  bool MdbcLimit;             ///<Avoid penetration in some direction (in development).                  //<vs_fttmdbc>
  tfloat3 MdbcLimitMin;       ///<Minimum limit to avoid penetration in some direction (in development). //<vs_fttmdbc>
  tfloat3 MdbcLimitMax;       ///<Maximum limit to avoid penetration in some direction (in development). //<vs_fttmdbc>
