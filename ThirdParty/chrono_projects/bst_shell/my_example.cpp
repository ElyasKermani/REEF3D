...
int main(int argc, char* argv[]) {
    ...
    for (int i = 0; i < TotalNumNodes; i++) {
        ...
        if (i % N_x == 0 || i % N_x == N_x-1 || (i / N_x) % N_y == 0 || (i / N_x) % N_y == N_y-1)
    ...
    ChVector<> E(70E9, 70E9, 70E9);

    ChVector<> nu(0.35, 0.35, 0.35);

    ChVector<> G(26E9, 26E9, 26E9);
    ...
    double pressure = 1; //Pascals

    printf("Pressure of %f\n", pressure);
    ...
    for (int i = 0; i < TotalNumElements; i++) {
        ...
        pressure_load->loader.SetStiff(false);          //// TODO:  user control?

        pressure_load->loader.SetIntegrationPoints(2);  //// TODO:  user control?

        mloadcontainer->Add(pressure_load);
