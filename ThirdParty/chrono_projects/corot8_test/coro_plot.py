...
# Read the text file
with open('/Users/weizhiwang/Project-Chrono-Linker/ThirdParty/chrono_projects/corot8_test/build/node_positions.txt', 'r') as file:
...
with open('/Users/weizhiwang/Project-Chrono-Linker/ThirdParty/chrono_projects/corot8_test/build/tip_node.txt', 'r') as file:
    for line in file:
