...
contact_force_phasicflow_linear_limited::contact_force_phasicflow_linear_limited(lexer*)
{
    kn = 1.0e6;
    kt = 0.5e6;
    cn = 1.0e4;
...
contact_force_phasicflow_linear_limited::~contact_force_phasicflow_linear_limited()
{
}

void contact_force_phasicflow_linear_limited::compute(lexer *p, ghostcell*, sixdof_obj *obj1, sixdof_obj *obj2,
