...
contact_force_dem_linear_limited::contact_force_dem_linear_limited(lexer *p)
{
    kn = p->R30;
    kt = p->R31;
    cn = 1.0e4;
...
contact_force_dem_linear_limited::~contact_force_dem_linear_limited()
{
}

void contact_force_dem_linear_limited::compute(lexer *p, ghostcell*, sixdof_obj *obj1, sixdof_obj *obj2,
