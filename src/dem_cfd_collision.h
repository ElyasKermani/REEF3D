...
public:
    ...
    void start_sphere_sphere(lexer*, fdm*, ghostcell*, vector<sixdof_obj*>&, int, bool, double dt_contact);
    void start_triangle_sat(lexer*, fdm*, ghostcell*, vector<sixdof_obj*>&, int, bool, double dt_contact);
    void start_adaptive(lexer*, fdm*, ghostcell*, vector<sixdof_obj*>&, int, bool, double dt_contact);
