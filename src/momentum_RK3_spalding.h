...
#ifndef MOMENTUM_RK3_SPALDING_H_
#define MOMENTUM_RK3_SPALDING_H_
...
class momentum_RK3_spalding : public momentum, public momentum_forcing, public bcmom_spalding
{
public:
    momentum_RK3_spalding(lexer*, fdm*, convection*, diffusion*, pressure*, poisson*, 
                 turbulence*, solver*, solver*, ioflow*, fsi*);
    virtual ~momentum_RK3_spalding();
