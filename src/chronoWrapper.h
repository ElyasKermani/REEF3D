...
public:
    ...
    void start(double _timestep, std::vector<std::vector<std::tuple<double,double,double,int>>> _forces, std::vector<std::vector<std::vector<double>>>* _pos, std::vector<std::vector<std::vector<double>>>* _vel, std::vector<std::vector<std::vector<int>>>*);
private:
