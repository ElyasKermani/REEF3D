...
Hertz-Mindlin contact model with tangential history and Coulomb friction
limiting that rescales both the tangential force and the stored history.
--------------------------------------------------------------------*/

#ifndef CONTACT_FORCE_HERTZ_MINDLIN_H_
#define CONTACT_FORCE_HERTZ_MINDLIN_H_
...
class contact_force_hertz_mindlin : public contact_force
{
public:

    contact_force_hertz_mindlin(lexer*);
    virtual ~contact_force_hertz_mindlin();
